...
<p>Having a good rushing offensive does help win a superbowl.</p> 
...
$sql = "SELECT Team, OffRushing FROM NFLTeamStats Order By `NFLTeamStats`.`OffRushing` DESC ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>Team</th><th>OffensiveRushing(YPG)</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Team"]. "</td><td>" . $row["OffRushing"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
