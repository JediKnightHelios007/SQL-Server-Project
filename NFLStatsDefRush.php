...
<p>Having a good rushing defense can get into superbowl championships.</p>
...
$sql = "SELECT Team, DefRushing FROM NFLTeamStats Order By `NFLTeamStats`.`DefRushing` ASC ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>Team</th><th>DefenseRushing(YPG)</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Team"]. "</td><td>" . $row["DefRushing"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
