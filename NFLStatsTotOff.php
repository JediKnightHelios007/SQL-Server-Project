...
<ul>
  ...
  <li><a href="http://jediknight008.net23.net/NFLStatsDefRush.php">NFL DefRus</a></li>
...
<p> Having the best offensive does not gurantee a superbowl</p>
...
$sql = "SELECT Team, TotalOffensive FROM NFLTeamStats Order By `NFLTeamStats`.`TotalOffensive` DESC ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>Team</th><th>TotalOffensive(YPG)</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Team"]. "</td><td>" . $row["TotalOffensive"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
