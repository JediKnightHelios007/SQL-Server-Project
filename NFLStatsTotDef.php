...
<p> Having the best defensive may guarantee superbowl championships.</p>
...
$sql = "SELECT Team, TotalDefense FROM NFLTeamStats Order By `NFLTeamStats`.`TotalDefense` ASC ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>Team</th><th>TotalDefense(YPG)</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Team"]. "</td><td>" . $row["TotalDefense"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
