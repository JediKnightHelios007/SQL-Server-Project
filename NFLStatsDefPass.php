...
<p>Denver Broncos having a good passing defense helped win the superbowl.</p>
...
$sql = "SELECT Team, DefPassing FROM NFLTeamStats Order By `NFLTeamStats`.`DefPassing` ASC ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>Team</th><th>DefensePassing(YPG)</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["Team"]. "</td><td>" . $row["DefPassing"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
